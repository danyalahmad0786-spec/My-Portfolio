...
import { Layers, Cpu, Briefcase, Building, Calendar, Coffee, Code2, Atom, FileCode } from 'lucide-react'
            ...
            <div className='h-2 w-full bg-[#131d30] rounded-full p-0.5'>
                ...
                <div className='fade-left'>
                    ...
                    <div className='space-y-6'>
                        {Experiences.map((exp)=>(
                            <div key={exp.id}
                            className='group relative p-6 rounded-2xlbg-[#1f1641]
                ...
                <div className='grow'>
                    ...
                    gap-2 sm:gap-4 mt-2 text-sm text-gray-400'>
