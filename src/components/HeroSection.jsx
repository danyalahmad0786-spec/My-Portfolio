            ...
            md:max-w-3xl mx-auto'>
                <div className='lg:py-6'>
                    ...
                    lg:text-left mx-auto max-w-xl'>
                        Passionate Computer Science student at KIIT with a strong interest in software development, artificial intelligence, and building real-world applications.
I enjoy learning new technologies, working on practical projects, and continuously improving my problem-solving and development skills.
A quick learner and team player who is always eager to take on new challenges and grow as a developer.
                    </p>
                    <div className='flex items-center gap-3 pt-9
                    flex-col sm:flex-row sm:w-max lg:mx-0'>
                        <button className='px-6 md:px-7 py-3 rounded-full
                        rounded-full relative group-full sm:w-max
                        flex justify-center'>
                            <span className='absolute inset-0 rounded-3xl group-hover:scale-105
                            origin-center transition-all ease-in-out bg-primary
                        ...
                        <button className='border border-cyan-400 px-6
                        md:px-7 py-3 rounded-full relative group w-full sm:w-max
                        flex justify-center'>
                ...
                <div className='lg:h-full md:flex'>
                    ...
                    relative'>
                        <div className='absolute z-0 top-1/2 -translate-y-1/2 w-5/6 right-0
                        h-[calc(80%+20px)] bg-linear-to-r opacity-25 from-[#0c64ac]
                        to-primary blur-2xl'>
                        </div>
                        <div className='absolute h-full z-10 p-2 -translate-y-1/2 top-1/2
